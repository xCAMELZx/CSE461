        ...
        equalButton.setOnClickListener(new OnClickListener() {                            
        	...
        	public void onClick(View arg0) { 
        		if ((input1.getText().length() == 0)                                                  
        			...
        			Oper1=operand1.toString()+ "-plus-" + operand2.toString();
        			...
        			try{
            			...
            			InetAddress local = InetAddress.getByName("192.168.0.20");
        			...
        			operand2= new Double(input2.getText().toString());
        			operator.setText(operand1+"-"+operand2);
        			Oper1=operand1.toString()+ "-min-" + operand2.toString();
        			...
        			* new Double(input2.getText().toString());                                            
        			...
        			operand2= new Double(input2.getText().toString());
        			operator.setText(operand1+"*"+operand2);
        			Oper1=operand1.toString()+ "-mul-" + operand2.toString();
        			/*try{
        			...
        			operand2= new Double(input2.getText().toString());
        			operator.setText(operand1 + "/" + operand2);
        			Oper1=operand1.toString()+ "-div-" + operand2.toString();
